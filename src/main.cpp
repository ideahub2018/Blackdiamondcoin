...
uint256 hashGenesisBlock("0x00fd2c161ab7b681d75ecf467c7b78ba38e524dfc111863e40623ffd910f9d1d");
static const unsigned int timeGenesisBlock = 1511921979;// changedxx
...
static const int64 nGenesisBlockCoin = 1 * COIN;
...
//if (IsProtocolV2(pindexLast->nHeight+1))
//{nActualTimespan = (nActualTimespan > 0 ) ? nActualTimespan : 0;}
	    int64 nTempTimespan;
...
if (IsProtocolV2(pindexLast->nHeight + 1)){
    if (0 < nActualTimespan && nActualTimespan < LimUp)
    {     
...
bool CBlock::AcceptBlock(CValidationState &state, CDiskBlockPos *dbp)
{
    ...
    if (hash != hashGenesisBlock) {
       ...
       if (IsProtocolV2(nHeight) && (GetBlockTime() < (pindexPrev->GetPastTimeLimit())))
		    return state.Invalid(error("AcceptBlock() : block's timestamp is too early"));
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00fd2c161ab7b681d75ecf467c7b78ba38e524dfc111863e40623ffd910f9d1d");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Blackdiamondcoin Come";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04b1b607aa8e0d7431011cdd5b730866c8fa2eb8cdc64b54d32bbdb11afe52511aad93ef46c9a47e5080f496a8439b30b063776570f58a2ff3df19b167fd433297") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1511921979;//timeGenesisBlock;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 70;
        block.nBirthdayA = 891381;
        block.nBirthdayB = 2676042;
 
       if (fTestNet)
        {
            block.nTime    = 1511921979;
            block.nNonce   = 70;
        }
        ...
        block.print();
        static const uint256 hashGenesisMerkleRoot = uint256("0x3e1fa517f57d9e6007068d75283e6f728deb3a7f102f394bace1dba0d9d23bb7");
...
unsigned char pchMessageStart[4] = { 0x99, 0x5a, 0x6b ,0x7d};
