...
const QString BITCOIN_IPC_PREFIX("Blackdiamondcoin:");
...
{
    QString name("BlackdiamondcoinQt");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Blackdiamondcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Blackdiamondcoin: click-to-pay handler");
    else
...
{
    // clicking on Blackdiamondcoin: URLs creates FileOpen events on the Mac:
